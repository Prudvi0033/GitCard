...
const LogoBox = () => {
  return (
    <div>
      <div className='relative flex items-center justify-center w-40 h-40 shadow-[inset_2px_2px_2px_#1a1a1a,_inset_-4px_2px_-4px_#2a2a2a] bg-neutral-900/90 border border-neutral-800/90 rounded-xl overflow-hidden'>
